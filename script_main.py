    ...
    if not exists(dir_input):
        ...
        layer_1: QgsVectorLayer = processing.run(
            'native:reprojectlayer',
            {
                ...
                'TARGET_CRS': QgsCoordinateReferenceSystem(vars_settings.crs_to),
                'OUTPUT': 'memory:'
            }
        )['OUTPUT']
        ...
        attributes_list += list(new_attributes_dict.keys())
        ...
        id_way_type: int = layer.fields().indexOf('way_type')
        id_offset: int = layer.fields().indexOf('offset')
        id_offset_cycleway_left: int = layer.fields().indexOf('offset_cycleway_left')
        id_offset_cycleway_right: int = layer.fields().indexOf('offset_cycleway_right')
        id_offset_sidewalk_left: int = layer.fields().indexOf('offset_sidewalk_left')
        id_offset_sidewalk_right: int = layer.fields().indexOf('offset_sidewalk_right')
        id_type: int = layer.fields().indexOf('type')
        id_side: int = layer.fields().indexOf('side')
        id_proc_width: int = layer.fields().indexOf('proc_width')
        id_proc_surface: int = layer.fields().indexOf('proc_surface')
        id_proc_smoothness: int = layer.fields().indexOf('proc_smoothness')
        id_proc_oneway: int = layer.fields().indexOf('proc_oneway')
        id_proc_sidepath: int = layer.fields().indexOf('proc_sidepath')
        id_proc_highway: int = layer.fields().indexOf('proc_highway')
        id_proc_maxspeed: int = layer.fields().indexOf('proc_maxspeed')
        id_proc_traffic_mode_left: int = layer.fields().indexOf('proc_traffic_mode_left')
        id_proc_traffic_mode_right: int = layer.fields().indexOf('proc_traffic_mode_right')
        id_proc_separation_left: int = layer.fields().indexOf('proc_separation_left')
        id_proc_separation_right: int = layer.fields().indexOf('proc_separation_right')
        id_proc_buffer_left: int = layer.fields().indexOf('proc_buffer_left')
        id_proc_buffer_right: int = layer.fields().indexOf('proc_buffer_right')
        id_proc_mandatory: int = layer.fields().indexOf('proc_mandatory')
        id_proc_traffic_sign: int = layer.fields().indexOf('proc_traffic_sign')
        id_fac_width: int = layer.fields().indexOf('fac_width')
        id_fac_surface: int = layer.fields().indexOf('fac_surface')
        id_fac_highway: int = layer.fields().indexOf('fac_highway')
        id_fac_maxspeed: int = layer.fields().indexOf('fac_maxspeed')
        id_fac_protection_level: int = layer.fields().indexOf('fac_protection_level')
        id_prot_level_separation_left: int = layer.fields().indexOf('prot_level_separation_left')
        id_prot_level_separation_right: int = layer.fields().indexOf('prot_level_separation_right')
        id_prot_level_buffer_left: int = layer.fields().indexOf('prot_level_buffer_left')
        id_prot_level_buffer_right: int = layer.fields().indexOf('prot_level_buffer_right')
        id_prot_level_left: int = layer.fields().indexOf('prot_level_left')
        id_prot_level_right: int = layer.fields().indexOf('prot_level_right')
        id_base_index: int = layer.fields().indexOf('base_index')
        id_fac_1: int = layer.fields().indexOf('fac_1')
        id_fac_2: int = layer.fields().indexOf('fac_2')
        id_fac_3: int = layer.fields().indexOf('fac_3')
        id_fac_4: int = layer.fields().indexOf('fac_4')
        id_index: int = layer.fields().indexOf('index')
        id_data_incompleteness: int = layer.fields().indexOf('data_incompleteness')
        id_data_missing: int = layer.fields().indexOf('data_missing')
        id_data_bonus: int = layer.fields().indexOf('data_bonus')
        id_data_malus: int = layer.fields().indexOf('data_malus')
        ...
        processing.run(
            ...
            {
                'INPUT': layer,
                'FIELDS': vars_settings.retained_attributes_list,
                'OUTPUT': f"{dir_output}"
            }
        )
