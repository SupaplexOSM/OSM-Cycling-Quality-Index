...
def step_05(
    ...
    #                if separation_left:
    #                    separation_left = helper_functions.getDelimitedValues(separation_left, ';', 'string')
    ...
    #                if separation_right:
    #                    separation_right = helper_functions.getDelimitedValues(separation_right, ';', 'string')
    ...
    missing_values = helper_functions.getDelimitedValues(data_missing, ';', 'string')
